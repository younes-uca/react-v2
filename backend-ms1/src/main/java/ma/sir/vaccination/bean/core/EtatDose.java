...
public class EtatDose   extends AuditBusinessObject     {
    ...
    public EtatDose(Long id,String libelle){
        this.id = id;
    ...
    public boolean equals(Object o) {
        ...
        EtatDose etatDose = (EtatDose) o;
        return id != null && id.equals(etatDose.id);
    }
