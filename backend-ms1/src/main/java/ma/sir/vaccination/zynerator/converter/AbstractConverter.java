package ma.sir.vaccination.zynerator.converter;


import ma.sir.vaccination.zynerator.bean.Etablissement;
import ma.sir.vaccination.zynerator.dto.EtablissementDto;

import ma.sir.vaccination.zynerator.util.ListUtil;
import ma.sir.vaccination.zynerator.audit.AuditBusinessObject;
import ma.sir.vaccination.zynerator.bean.BusinessObject;
import ma.sir.vaccination.zynerator.dto.AuditBaseDto;
import ma.sir.vaccination.zynerator.dto.BaseDto;
import ma.sir.vaccination.zynerator.util.DateUtil;
import ma.sir.vaccination.zynerator.util.RefelexivityUtil;
import ma.sir.vaccination.zynerator.util.StringUtil;
import ma.sir.vaccination.zynerator.util.Utils;
