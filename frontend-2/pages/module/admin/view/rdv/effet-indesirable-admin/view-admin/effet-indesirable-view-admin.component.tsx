...
return(
<Dialog visible={visible} style={{width: '70vw'}} header="EffetIndesirable Details" modal className="p-fluid" footer={itemDialogFooter} onHide={hideDialog} >
...
<TabPanel header="EffetIndesirable">
    <div className="formgrid grid">
        ...
        <div className="field col-6">
            ...
            <Calendar id="dateFait" value={selectedItem?.dateFait} disabled dateFormat="dd/mm/yy" showTime />
        </div>
