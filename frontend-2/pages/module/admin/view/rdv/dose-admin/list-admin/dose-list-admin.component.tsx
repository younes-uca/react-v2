        ...
        <div className="col-12">
            <div className="card">
                ...
                <DataTable ref={dt} value={items} selection={selectedItems} onSelectionChange={(e) => setSelectedItems(e.value as DoseDto[])} dataKey="id" className="datatable-responsive" globalFilter={globalFilter} header={header} responsiveLayout="scroll" >
                    ...
                    <Column field="rendezVous.id" header="RendezVous" sortable></Column>
                    
                    
                    <Column field="etatDose.libelle" header="EtatDose" sortable></Column>
                    
                    
                    <Column field="dateDebutPrevu" header="DateDebutPrevu" sortable></Column>
                    
                    
                    <Column field="dateDebutEffectif" header="DateDebutEffectif" sortable></Column>
